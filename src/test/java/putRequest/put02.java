...
import pojaDatas.BookingDatesPojoPost;
import pojaDatas.RestFulBookingPojo;
...
public class put02 extends RestFullBookerHerOkuAppBaseURL {
    ...
    "additionalneeds" : "API and Appium"
        ...
        //403 ------>> Forbidden    - - -- - -- - -- Token veya ilgili auth. metodu ne ise onunla ilgili olarak value var fakat yanlış yahut expire olmuş olabilir.
