...
import pojaDatas.CryptoCurrencyPojo;
import pojaDatas.CustomerInfoPojo;
...
public class Post04_ınterview {
     /*
     //https://dev.bitpace.com/bitpace-merchant-rest-api
    ...
    Given
        ...
        adresine POST metodu  ile request atılıp token alınmalı.
    ...
    Token alındıktan sonra aşğaıdaki işlemlere geçebiliriz.
        ...
        **Alınan Token Headers ta Bearer Auth. olarak gönderilecektir.**
